...
public class test extends AppCompatActivity {
    ...
    private void insertData() {
        ...
        if(ques.isEmpty()){
            ...
            Toast.makeText(this, "Enter value 3", Toast.LENGTH_SHORT).show();
            return;
        }
        else if(o4.isEmpty()){
            Toast.makeText(this, "Enter value 4", Toast.LENGTH_SHORT).show();
            return;
        }
        else if(ans.isEmpty()){
            ...
            StringRequest request = new StringRequest(Request.Method.POST, addurl, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if(response.equalsIgnoreCase("inserted")){
                        Toast.makeText(test.this, "inserted", Toast.LENGTH_SHORT).show();
